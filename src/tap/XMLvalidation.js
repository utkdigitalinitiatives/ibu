 ...
 * XMLvalidation expects a file path to a MODS XML file.
 * XMLvalidation returns an array of errors for a given MODS XML file to the IbuErrorDocs collection.
 *
 * @param {[String]} input [MODS XML file path]
 * @return {[Array]}       [Success] or [Error 1, Error 2, Error 3, ...]
 *
 */
